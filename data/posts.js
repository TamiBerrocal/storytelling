export default [
  ...
  },
  {
    ...
    content: [
      ...
      'Los últimos meses antes de irse fueron tensos. Aunque no lo diga en voz alta, es claro que se fue por todo lo que pasó en el bar esa noche de Septiembre. Ahora pienso en eso y me parece tonta toda la situación. Cómo mamá se enojó terriblemente con ella. “Qué van a pensar los Roldán de nosotros” le gritaba mientras yo lloraba desconsolada. Me molesta que sienta que tenga que cuidarme todo el tiempo. Me molesta que no haya cumplido su rol de madre y hacernos entender de que eran cosas de chicas y que todo iba a pasar. Me molesta que se preocupe más por cómo nos vemos frente al resto, que por lo que en verdad pasa en nuestra familia. A veces pienso que podría imitar a Astrid e irme un poco más lejos para poder librarme un poco de esta sofocante protección maternal.',
      'Me gustaría llamarla, pero no sé qué decirle. Me apena pensar que ahora la relación con mi hermana se basa en un par de mensajes de vez en cuando, forzados y formales. Aunque vuelva de Buenos Aires, aunque pueda explicarle que todo ya pasó, el daño ya está hecho. Sé que se siente herida y fuera de lugar en casa. De todas maneras, aunque lo solucionáramos ¿qué cambiaría? Lo nuestro estaba roto mucho antes de todo lo que pasó en el Boca de Lobo. Quizás fue un detonante para que tomáramos esta distancia. Quizás es lo mejor para nosotras.',
      { text: 'Julia', style: 'italic right-aligned' },
    ],
    author: 'J',
  },
  {
    ...
    photo: 'astrid1a.jpg',
    content: [
      'Anoche volví a tener ese sueño. Me desperté enredada en las sábanas y cubierta de transpiración, con el corazón tan apretado en un nudo que me dolía en el pecho. Tardé un rato en entender que solo soñaba. Me toqué la cara y me di cuenta de que había estado llorando. Eso nunca había pasado.',
      ...
      'Pasé el resto de la noche pensando en el pasado. En Julia y en mamá. En el día que todo se rompió y yo entendí que ese no era mi lugar, que nunca iba a poder ser yo misma ahí. Creo que siempre tuve la sospecha de cómo eran las cosas. A veces, estando sola, decía mi nombre en voz alta y lo sentía diferente, como si me pesara en la boca. Como si me hubieran marcado desde el principio para ser distinta, y nada de lo que hiciera fuera suficiente para pertenecer. No como Julia.“Unos nacen con estrella y otros nacen estrellados” decía siempre mamá, y yo entendía muy bien a qué se refería. Julia nunca tuvo que intentar demasiado. No sé qué podría haber hecho como ella para que mamá me aceptara. Tampoco entendí a Julia, nunca. Creo que nunca hablamos (ni vivimos) en los mismos términos.',
  ...
  },
  {
    content: [
      ...
      { text: 'Construimos mundos ideales', style: 'italic' },
      { text: 'caminados por personas estupendas', style: 'italic' },
      { text: 'relacionadas de perfectos modos,', style: 'italic' },
      {
        text: 'soñamos un futuro rosa de ilusiones circulares',
        style: 'italic',
      },
      ...
      { text: '¿Y dónde entran los humanos?,', style: 'italic' },
      { text: 'porque ellos son sólo personajes de papel', style: 'italic' },
      { text: 'residentes de la imaginación,', style: 'italic' },
      {
        text: 'de personas imperfectas que deforman realidades',
        style: 'italic',
      },
      {
        text: 'y caminan en mundos de cristal a punto de estallar.',
        style: 'italic',
      },
      ...
      { text: 'Las victorias que creemos merecer', style: 'italic' },
      { text: 'son ríos correntosos', style: 'italic' },
      { text: 'nos arrastran sin piedad hasta un océano', style: 'italic' },
      { text: 'de desidia y dolores.', style: 'italic' },
      { text: 'Solo debemos entender', style: 'italic' },
